...
with st.sidebar.expander("📱 Facebook Pages", expanded=True):
...
with st.sidebar.expander("🔗 Manual Check"):
    ...
    # Hardcoded list since status might not be in secrets
    manual_brands = {
        "Colona": "https://www.colona.be/",
        "Delicatessen17": "https://www.facebook.com/kalasgroup/",
        "Lecker": "https://leckerfood.com.my/",
        "Rodina": "https://www.facebook.com/p/Rodina-100079499079169/"
    }
    for brand, link in manual_brands.items():
